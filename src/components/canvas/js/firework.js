export default function Fireworks () {
  ...
  let hitTest = (x1, y1, w1, h1, x2, y2, w2, h2) => {
  ...
  window.requestAnimFrame = (function () {
    return (
      ...
      window.mozRuestAnimationFrame ||
      window.oRequestAnimationFrame ||
      this.window.mozRuestAnimationFrame ||
      function (a) {
  ...
  self.updateParticles = function () {
    ...
    while (i--) {
      ...
      let radians = p.angle * Math.PI / 180

      let vx = Math.cos(radians) * p.speed

      let vy = Math.sin(radians) * p.speed
  ...
  self.createFireworks = function (startX, startY, targetX, targetY) {
    let newFirework = {
      ...
      angle: Math.atan2(targetX - startY, targetX - startX),
  ...
  self.bindEvents = function () {
    window.addEventListener('resize', function () {
      ...
      self.timeout = this.setTimeout(function () {
        self.canvas.width = self.cw = window.innerWidth
    ...
    self.canvas.addEventListener('mouseup', function (e) {
      self.canvas.removeEventlistener('mousemove.fireworks')
    })
  }
  ...
  self.clear = function () {
    ...
    self.ctx.clearReact(0, 0, self.cw, self.ch)
  }
  ...
  self.canvasLoop = function () {
    ...
    self.ctx.fillReact(0, 0, self.cw, self.ch)
